	...
	return (
		<AuthenticatedLayout>
            ...
            <form onSubmit={submit} className='px-10'>
				...
				<div>
					<InputLabel forInput="id_number" value="ID Number" />
                ...
                <div className="flex items-center justify-end mt-4">
                    {/* <Link href={route('official-login')} className="underline text-sm text-gray-600 hover:text-gray-900">
                        Already registered?
                    </Link> */}
